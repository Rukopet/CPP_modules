...
public:
	...
	reverse_iterator rbegin() { return std::rbegin(std::stack<T, Container>::c); };
	const_reverse_iterator rbegin() const { return std::rbegin(std::stack<T, Container>::c); };

	reverse_iterator rend() { return std::rend(std::stack<T, Container>::c); };
	const_reverse_iterator rend() const { return std::rend(std::stack<T, Container>::c); };
};
